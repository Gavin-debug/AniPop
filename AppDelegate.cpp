...
#error "Don't use AudioEngine and AudioEngine at the same time. Please just select one in your game!"
#endif
...
void AppDelegate::applicationDidEnterBackground() {
    ...
    AudioEngine::getInstance()->pauseAllEffects();
#endif
}
...
void AppDelegate::applicationWillEnterForeground() {
    ...
    AudioEngine::getInstance()->resumeAllEffects();
#endif
}
